...
https://hg.python.org/cpython/file/dc758f51b8f5/Lib/html/entities.py

Copy of the Python licence inserted at the end for to comply with it.

Minimal conversion for Python 2 support applied.
