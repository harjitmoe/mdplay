...
for ka,(ku,he) in KATATAB[:]:
    ...
    if he in ("fu","vu"):
        ...
        if not apriori:
            KATATAB.push(apriori,(ka+"ァ",(ku[:-1]+"a",he[:-1]+"ha")))
            KATATAB.push(apriori,(ka+"ィ",(ku[:-1]+"i",he[:-1]+"hi")))
            KATATAB.push(apriori,(ka+"ェ",(ku[:-1]+"e",he[:-1]+"he")))
            KATATAB.push(apriori,(ka+"ォ",(ku[:-1]+"o",he[:-1]+"ho")))
    if ku == "i":
